<x-app-layout>
    ...
    <section class="w-full md:pt-32 pb-8 bg-milk font-jakarta">
        ...
        <nav class="px-16 mb-4 hidden md:flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">{{ $training->slug }}</span>
            </div>
            </li>
        </ol>
        </nav>
