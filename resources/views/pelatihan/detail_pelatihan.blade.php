<x-app-layout>
    ...
    <section class="w-full md:pt-32 pb-8 bg-milk font-jakarta">
        ...
        {{-- Mobile Tabs Nav (Hidden on Medium screens and up) --}}
        ...
        {{-- Main Container for both Desktop Grid and Mobile Tab Content --}}
        <div id="myTabContent" class="md:grid md:grid-cols-3 md:gap-8 md:px-16">

            {{-- Left Column / Main Content Tab --}}
            ...
            {{-- Right Column / Sidebar Tab --}}
            {{-- On mobile, this will be hidden by default (`hidden`) and shown when its tab is clicked --}}
                ...
                <div class="w-full px-6 py-4 rounded-lg bg-white">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="flex flex-col items-center justify-center bg-milk p-4 rounded-lg shadow-sm">
                            <svg class="w-24 h-24"> {{-- Adjusted size --}}
