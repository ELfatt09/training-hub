<x-app-layout>
    ...
    <section class="w-full font-medium">
        <div class="flex flex-col gap-4 lg:gap-0 lg:grid grid-cols-8 px-6 lg:px-16 pb-6 lg:py-6">
            <div class="order-2 lg:order-1 col-span-6 space-y-3 lg:space-y-6">
            ...
            <div class="order-1 lg:order-2 col-span-2 border-2 border-gray-300 rounded-2xl lg:ml-8 py-2 space-y-6 lg:space-y-2">
