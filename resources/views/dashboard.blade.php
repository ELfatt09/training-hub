<x-app-layout class="w-full scroll-smooth">
    ...
    <!-- Pelatihan Unggulan -->
     <section id="pelatihan" class="h-fit px-6 md:px-0 w-full flex flex-col space-y-12 justify-center items-center bg-milk">
        ...
        <div class="flex justify-center mt-4">
            <a href="{{ route('pelatihan') }}" class="capitalize flex items-center text-sm md:text-md bg-primary border border-primary px-4 py-2 rounded-md text-white hover:bg-transparent hover:text-primary hover:border transition">
