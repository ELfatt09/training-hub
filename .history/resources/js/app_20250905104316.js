 ...
 const upperBar = document.getElementById("upper-bar");
  ...
  window.addEventListener("scroll", function () {
    ...
    if (currentScroll > 50) {
      ...
      lowerBar.classList.remove("md:py-4"); // ganti sesuai tinggi upper-bar// ganti sesuai tinggi upper-bar
      lowerBar.classList.add("md:py-8"); // ganti sesuai tinggi upper-bar// ganti sesuai tinggi upper-bar
    } else {
      // Kalau di posisi paling atas → tampilkan lagi
      upperBar.style.transform = "translateY(0)";
      lowerBar.style.transform = "translateY(0)";
      lowerBar.classList.remove("md:py-8"); 
      lowerBar.classList.add("md:py-4"); // ganti sesuai tinggi upper-bar// ganti sesuai tinggi upper-bar
    }
  });
};
// Init swiper
