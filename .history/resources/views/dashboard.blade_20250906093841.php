<x-app-layout class="w-full scroll-smooth">
    ...
    {{-- CTA --}}
    <section class="w-full h-[50vh] my-12 px-12 hidden md:flex justify-center items-center bg-milk">
         ...
         <div class="block gap-2 px-0 md:px-32">
            <div class="flex md:grid grid-cols-4 gap-4 justify-center items-center">
                <div class="flex w-full justify-center items-center gap-4 md:col-span-1">
                    <h1 class="hidden md:flex text-md md:text-4xl font-bold"><i class="fa-solid fa-star-of-life text-secondary"></i> Artikel Kami <i class="fa-solid fa-star-of-life text-secondary"></i></h1>
