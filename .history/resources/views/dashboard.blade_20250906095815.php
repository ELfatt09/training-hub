...
<section id="pelatihan" class="h-fit md:h-[100vh] w-full bg-milk flex flex-col justify-center items-center">
  <div class="w-full max-w-6xl px-6 md:px-12 flex flex-col space-y-12">
    ...
    <!-- Cards -->
    <div class="flex md:grid overflow-x-auto md:overflow-visible snap-x md:snap-none snap-mandatory md:grid-cols-3 gap-6">
      <x-card
