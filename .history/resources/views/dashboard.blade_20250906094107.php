<x-app-layout class="w-full scroll-smooth">
    ...
    {{-- CTA --}}
    <section class="w-full h-[50vh] py-12 px-12 hidden md:flex justify-center items-center bg-milk">
    ...
    {{-- Article --}}
        <section class="flex flex-col w-full h-fit md:h-[100vh] pb-12 md:pb-0 space-y-6 md:space-y-0 md:px-12 bg-milk py-12 mb-12">
             <!-- Title -->
