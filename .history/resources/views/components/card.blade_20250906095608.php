<!-- Single Card -->
<div class="w-[60%] h-auto sm:w-full sm:h-auto md:h-[50vh] flex-shrink-0 bg-white shadow-lg rounded-2xl flex flex-col justify-between border border-primary mx-auto">
    <!-- Image -->
