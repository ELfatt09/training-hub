<!-- Single Card -->
<div class="w-[50%] h-[50%] md:w-full md:h-[50vh] max-w-xs flex-shrink-0 bg-white shadow-lg rounded-2xl flex flex-col justify-between border border-primary mx-auto">
    <!-- Image -->
