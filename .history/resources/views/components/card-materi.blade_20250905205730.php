<div id="accordion-open" data-accordion="open" class="w-full mx-auto mt-6">
                                ...
                                <div id="accordion-open-heading-1">
                                    <button type="button" 
                                    class="flex items-center justify-between w-full p-4 font-medium text-left text-gray-700 bg-gray-100 rounded-lg border"
                                ...
                                <a id="accordion-open-body-1" class="hidden" aria-labelledby="accordion-open-heading-1">
                                    <div class="p-4 border border-t-0 rounded-b-lg bg-white text-sm text-gray-600 flex justify-between">
                                        <div class="space-y-2">
