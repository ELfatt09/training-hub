<!-- Single Card -->
                 <div class="px-6 py-4 border-2 max-w-xl md:max border-primary rounded-xl">
                    <!-- Profile -->
                     ...
                     <!-- Comment -->
                      <div>
                        <p class="text-xs w-full max-w-[15rem] lg:text-lg line-clamp-3 lg:line-clamp-none">{{ $comment }}</p>
                      </div>
                 </div>
                <!-- Single Card End -->
