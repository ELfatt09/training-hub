<!-- Single Card -->
<div class="w-full h-[50vh] max-w-xs flex-shrink-0 bg-white shadow-md rounded-lg flex flex-col justify-between border border-primary mx-auto">
    <!-- Image -->
    <div class="w-full flex justify-center py-2">
        <img class="w-10/12 h-full object-cover rounded-md" src="{{ $image }}" alt="">
    </div>
