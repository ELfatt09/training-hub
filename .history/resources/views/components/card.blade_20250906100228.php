<!-- Single Card -->
<div class="w-[60%] h-[40%] md:w-full md:h-[55vh] max-w-xs flex-shrink-0 bg-white shadow-lg rounded-2xl flex flex-col justify-evenly border border-primary mx-auto">
    <!-- Image -->
