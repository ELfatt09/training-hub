  {{-- Single Card --}}
        <div class="max-w-[17.5rem] h-[40vh] w-full flex flex-col justify-center space-y-4 px-4 border border-primary bg-white rounded-xl">
            ...
            {{-- Button --}}
            <div class="w-full">
                <a class="w-full flex justify-center items-center text-white bg-primary px-4 py-2 hover:bg-transparent border border-primary transition-all hover:text-primary" href="">Ajukan Magang</a>
            </div>
        </div>
    {{-- Single Card --}}