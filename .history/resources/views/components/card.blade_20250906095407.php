<!-- Single Card -->
<div class="w-[90%] sm:w-[90%] sm:max-w-sm md:w-full md:h-[50vh] max-w-xs flex-shrink-0 bg-white shadow-lg rounded-2xl flex flex-col justify-between border border-primary mx-auto">
    <!-- Image -->
    ...
    <div class="p-2 space-y-4 px-4">
        ...
        <!-- Detail Desc -->
        <p class="text-[.70rem] font-normal text-darkoff text-start">
            {{ $deskripsi }}
        </p>
        ...
        <div class="w-full">
            <a href="#" 
               class="w-full text-xs md:text-md flex justify-center items-center bg-primary font-medium border border-primary text-white px-2 py-1 rounded-md hover:text-primary hover:border hover:bg-transparent transition">
               Pelajari Sekarang
            </a>
        </div>
    </div>
