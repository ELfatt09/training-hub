...
<div class="w-[60%] h-[40%] md:w-full md:h-[50vh] max-w-xs flex-shrink-0 bg-white shadow-lg rounded-2xl flex flex-col justify-between border border-primary mx-auto">
    ...
    <div class="p-2 space-y-4 px-4">
        ...
        <div class="w-full">
            <a href="#" 
               class="w-full text-xs md:text-[.9rem] flex justify-center items-center bg-primary font-medium border border-primary text-white px-4 py-2 rounded-md hover:text-primary hover:border hover:bg-transparent transition">
               Pelajari Sekarang
            </a>
        </div>
    </div>
