            ...
            <!-- Left Side -->
             <div class="flex justify-start w-2/3">
                ...
                <ul class="flex gap-5 items-center">
                    ...
                    <li>
                        <a class="hover:border-b-2 pb-1 text-sm md:text-lg hover:border-primary transition-all ease-in-out font-medium md:flex mt-1 items-center justify-center" href="detailPelatihan.blade.php">
                            Pelatihan
