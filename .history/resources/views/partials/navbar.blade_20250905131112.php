<header class="fixed w-full z-40">
        ...
        <div id="upper-bar" class="hidden md:flex w-full h-max overflow-hidden transition-all duration-300">
            ...
            <!-- Left Side -->
            <div class="bg-primary rounded-br-full shadow-lg w-2/3 h-[32%] lg:h-[2.5rem] py-2 px-4 absolute z-0">
                <ul class="flex items-center gap-8">
                    <li class="lg:text-[2rem] text-center text-xs">
