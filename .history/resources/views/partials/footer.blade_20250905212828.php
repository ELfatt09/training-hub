  <footer class="w-full flex flex-col">
       ...
       {{-- Down --}}
            <div class="flex bg-primary w-full px-4 md:px-12 text-white md:text-darkoff justify-between py-6 text-[0.60rem] md:text-md">
                <a href="#beranda"><i class="fa-solid fa-up-to-line mr-2"></i> Kembali Ke Atas</a>
