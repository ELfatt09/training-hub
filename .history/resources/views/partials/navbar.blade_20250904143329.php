<header class="fixed w-full z-40">
        ...
        <!-- Upper Content -->
        <div class="hidden md:flex w-full h-max overflow-hidden">
       ...
       <!-- Lower Content -->
        <div class="hidden lg:py-0 bg-white md:flex md:py-4 justify-between w-full shadow-md px-10">
            ...
            <!-- Left Side -->
             <div class="flex justify-start w-2/3">
                ...
                <ul class="flex gap-5 items-center">
                    ...
                    <li>
                        <a class="hover:border-b-2 pb-1 text-sm md:text-lg hover:border-primary transition-all ease-in-out font-medium md:flex mt-1 items-center justify-center" href="">
                            Pelatihan
