            ...
            <!-- Left Side -->
             <div class="flex justify-start w-2/3">
                ...
                <ul class="flex gap-5 items-center">
                    <li>
                        <a class="border-b-2 pb-1 text-sm lg:text-[1.2rem] border-primary font-bold" href="">
                            Beranda
                        </a>
                    </li>
                    <li>
                        <a class="hover:border-b-2 pb-1 text-sm lg:text-[1.2rem] hover:border-primary transition-all ease-in-out font-medium" href="#kejuruan">
                            Kejuruan
                        </a>
                    </li>
                    <li>
                        <a class="hover:border-b-2 pb-1 text-sm lg:text-[1.2rem] hover:border-primary transition-all ease-in-out font-medium md:flex mt-1 items-center justify-center" href="{{ route('detail.pelatihan') }}">
                            Pelatihan
                            <span class="ml-2 text-sm lg:text-[1.2rem]"><i class="fa-solid fa-caret-down"></i></span>
                        </a>
                    </li>
                    <li>
                        <a class="hover:border-b-2 pb-1 text-sm lg:text-[1.2rem] hover:border-primary transition-all ease-in-out font-medium" href="">
                            Magang
                        </a>
                    </li>
                    <li>
