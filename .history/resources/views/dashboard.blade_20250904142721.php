<x-app-layout class="w-full scroll-smooth">
     ...
     <section id="beranda" class="flex h-fit md::h-[70vh] w-full font-jakarta bg-milk">     
            ...
            <!-- Hero text -->
             <div class="space-y-6">
                <div class="w-full flex flex-col place-items-center">
                    ...
                    <h2 class="text-black text-lg  md:text-6xl font-semibold line-clamp-2 text-center">Dolor sit amet Consectetur Elit</h2>
                </div>
        ...
        <!-- Right Side -->
         <div class="hidden md:flex flex-col justify-end mt-60 px-20 w-1/2 h-[50vh]">
            ...
            <div class="bg-white w-fit h-fit px-4 py-2 shadow-lg absolute top-32 right-10 rounded-md">
    ...
    <!-- Hero End -->
        ...
        <div class="flex animate-marquee space-x-12">
            @foreach(['logo-telkom.svg', 'logo-adf.svg','logo-bnp.svg','logo-citraHusada.svg','logo-denso.svg','logo-kirana.svg', 'logo-klik.svg', 'logo-sinarmas.svg',  'logo-wika.svg'] as $logo)
    ...
    <!-- Program Kejuruan -->
     <section id="kejuruan" class="h-[90vh] w-full flex flex-col space-y-12 justify-center items-center bg-milk">
        <!-- Text -->
        <div class="flex flex-col px-6 md:px-0 justify-center items-center space-y-3">
            ...
            <p class="text-justify md:text-center text-sm md:text-lg font-medium text-gray-500 line-clamp-4 md:line-clamp-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla rhoncus eu ante nec luctus. Maecenas lacus dui, porta eu ullamcorper eget, dignissim at elit. Ut lorem risus, volutpat a risus ut, lobortis aliquet orci.</p>
        </div>
    ...
    {{-- Kata Pengguna --}}
    <section id="katapengguna" class="md:flex flex-col w-full md:mt-24 h-fit md:h-[100vh] py-12 md:px-10 md:mb-12 bg-milk">
        <!-- Title -->
