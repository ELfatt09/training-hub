            ...
            {{-- Search --}}
                <div class="w-full flex justify-center">
                    ...
                    >
                        ...
                        <input placeholder="Cari Pelatihan..." class="w-full rounded-full border border-primary bg-transparent focus:outline-none focus:ring-0 focus:border" type="text">
                    </form>
                </div>
            {{-- Search --}}
        </div>
