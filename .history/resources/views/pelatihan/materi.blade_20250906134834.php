<x-app-layout>
    ...
    <div class="grid grid-cols-3 bg-milk h-fit py-32">
        ...
        <div class="col-span-1 bg-white px-6">
            {{-- Serach --}}
            ...
            {{-- Section 1 --}}
            <div class="">
                <div id="accordion-open" data-accordion="open" class="w-full mx-auto mt-6 px-4">
                    <div id="accordion-open-heading-1">
                        <button type="button" 
                            class="flex items-center justify-between w-full px-2 py-2 font-medium text-left text-gray-700 bg-white border-primary border rounded-md"
