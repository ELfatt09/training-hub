<x-app-layout>
    ...
    <div class="grid grid-cols-3 bg-milk h-fit py-32">
        <div class="col-span-2 w-full pl-12 pr-4 bg-white">
            {{-- Top --}}
                <div class="flex w-full items-center justify-between border-2 border-primary py-4 px-4 rounded-md shadow-md mb-4">
            ...
            {{-- Materi --}}
                <div class="space-y-4">
                    {{-- Title --}}
                    <div class="text-4xl font-bold m">
                        <h1>1.1 Sinopsis</h1>
                    </div>
        ...
        <div class="col-span-1 bg-white">
            ...
            <div>
                <div id="accordion-open" data-accordion="open" class="w-full mx-auto mt-6">
                    ...
                    <a href="#" class="flex w-full justify-between items-center text-gray-600 hover:text-primary">
