    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
            <div class="flex items-center">
                <a href="{{ url('../dashboard.blade.php') }}" class="inline-flex items-center text-gray-600 hover:text-teal-600">
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ url('/pelatihan') }}" class="ml-1 text-gray-600 hover:text-teal-600 md:ml-2">
                    Pelatihan
                </a>
            </div>
        </li>
        ...
        <li>
            <div class="flex items-center">
                <i class="fa-solid fa-angle-right mx-2 text-gray-400"></i>
                <span class="ml-1 text-gray-400 md:ml-2">
                    {{ $pelatihan->nama }}
                </span>
            </div>
        </li>
