    ...
    {{-- Main --}}
        <div class="grid grid-cols-3 w-full pt-36 pb-8 bg-milk">
            ...
            <div class="col-span-1 space-y-2 pr-16 w-full">
                ...
                {{-- Section 2 --}}
                    <div class="text-3xl flex flex-col j font-bold text-secondary space-y-2 px-6 py-4 rounded-lg bg-white">
                        <h1>Gratis</h1>

                        <div class="text-white bg-secondary border border-secondary hover:bg-transparent hover:text-secondary transition-all text-xl capitalize justify-center items-center flex py-2 rounded-[5px]">
