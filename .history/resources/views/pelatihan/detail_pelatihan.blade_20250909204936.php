            ...
            <div class="col-span-1 space-y-2 pr-16 w-full">
                ...
                {{-- Section 2 --}}
                    <div class="text-3xl font-bold text-secondary space-y-2 px-6 py-4 rounded-lg bg-white">
                        ...
                        <div class="text-white bg-secondary border border-secondary hover:bg-transparent hover:text-secondary transiti text-xl capitalize justify-center items-center flex py-2 rounded-[5px]">
