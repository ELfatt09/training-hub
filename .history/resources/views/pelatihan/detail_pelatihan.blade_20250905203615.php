<x-guest-layout>
    ...
    {{-- Main --}}
        <div class="grid grid-cols-3 w-full py-6 bg-milk">
            ...
            <div class="col-span-1 space-y-2 pr-16 w-full">
                ...
                {{-- Section 4 --}}
                    <div class="w-full max-w-md p-4 bg-white rounded-md shadow">
                    <p class="font-semibold text-gray-800 mb-4">Statistik Pelatihan</p>

                    <div class="grid grid-cols-2 gap-4">
                        <!-- Card 1 -->
                        <div class="flex flex-col items-center justify-center bg-gray-50 p-4 rounded-lg shadow-sm">
                        <!-- Lingkaran -->
                        <svg class="w-24 h-24">
                            <circle
                            class="text-gray-300"
