<x-app-layout>
    ...
    <div class="grid grid-cols-3 bg-milk h-fit py-32 relative gap-4">
        <div class="col-span-2 w-full pl-12 pr-4 py-4">
            {{-- Top --}}
        ...
        <div class="col-span-1 space-y-4 bg-white px-6 h-fit py-4 rounded-md absolute top-32 right-0 w-[calc(33.333%-1rem)]">
            {{-- Search --}}
            ...
            <div class="border border-primary rounded-md">
                <div id="accordion-open" data-accordion="open" class="w-full mx-auto py-4 px-4">
                    ...
                    <div id="accordion-open-body-1" class="hidden px-4 py-2 space-y-2"
                        ...
                        <a href="#" class="flex font-semibold w-full justify-between items-center text-darkoff hover:text-primary">
