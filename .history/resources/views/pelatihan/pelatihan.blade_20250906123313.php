        ...
        <div class="pt-32 w-full place-items-center py-8 px-12 space-y-4">
            ...
            {{-- Search --}}
                <div class="w-full flex justify-center">
                    <form 
                    action="{{ route('pelatihan.search') }}" {{-- Update this route to match your search logic --}}
                    method="GET"
                    class="w-1/2"
                    >
                        <i class="fa-regular fa-magnifying-glass absolute right-[28%] bottom-[61.3%] text-primary"></i>
                        <input 
                            name="query" {{-- Add a name attribute for the search query --}}
                            placeholder="Cari Pelatihan..." 
                            class="w-full rounded-full border-2 border-primary bg-transparent focus:outline-none focus:ring-0 focus:border-secondary" 
                            type="text">
                    </form>
                </div>
            {{-- Search --}}
