<x-app-layout>
    ...
    <div class="grid grid-cols-3 bg-milk h-fit pt-[6.5rem] pb-12">
        <div class="col-span-2 w-full pl-12 pr-4 py-4 bg-white rounded-md">
            {{-- Top --}}
                <div class="flex w-full items-center justify-between border-2 border-primary py-4 px-4 rounded-md shadow-md mb-8">
        ...
        <div class="col-span-1 relative mx-4">
        <div class="sticky top-4">
            <div class="space-y-4 bg-white px-6 h-fit py-24 rounded-md">
                {{--  --}}
                ...
                <div class="border border-primary rounded-md">
                    <div id="accordion-open" data-accordion="open" class="w-full mx-auto py-4 px-4">
                        ...
                        <div id="accordion-open-body-1" class="hidden px-4 py-2 space-y-2"
                ...
                <div class="border border-primary rounded-md">
                    <div id="accordion-open" data-accordion="open" class="w-full mx-auto py-4 px-4">
                        ...
                        <div id="accordion-open-body-2" class="hidden px-4 py-2 space-y-2"
                            ...
                            <a href="#"
                                class="flex font-semibold w-full justify-between items-center text-darkoff hover:text-primary">
                                <span>2.2 Sinopsis</span>
                                <i class="fa-solid fa-check text-primary"></i>
                            </a>
                            <a href="#"
                                class="flex font-semibold w-full justify-between items-center text-darkoff hover:text-primary">
                                <span>2.3 Sinopsis</span>
                                <i class="fa-solid fa-check text-primary"></i>
                            </a>
                            <a href="#"
                                class="flex font-semibold w-full justify-between items-center text-darkoff hover:text-primary">
                                <span>2.4 Sinopsis</span>
                                <i class="fa-solid fa-check text-primary"></i>
                            </a>
                            <a href="#"
                                class="flex font-semibold w-full justify-between items-center text-darkoff hover:text-primary">
                                <span>2.5 Sinopsis</span>
                                <i class="fa-solid fa-check text-primary"></i>
                            </a>
                            <a href="#"
                                class="flex font-semibold w-full justify-between items-center text-darkoff hover:text-primary">
                                <span>2.6 Sinopsis</span>
                                <i class="fa-solid fa-check text-primary"></i>
                            </a>
                            <!-- dst -->
                        </div>
