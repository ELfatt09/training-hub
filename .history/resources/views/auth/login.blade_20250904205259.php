<x-guest-layout>
    <section class="w-full flex py-12 md:h-fit">
        <!-- Left Side -->
        <div class="lg:w-1/2 flex flex-col justify-center lg:h-[90vh] space-y-4 md:space-y-8 px-6
        md:px-12">
            <!-- Upper -->
            <div class="space-y-6">
                <!-- logo -->
        ...
        <!-- Right Side -->
        <div class="hidden md:flex justify-center items-center lg:w-1/2 h-full p-2">
