<x-guest-layout>
    <section class="w-full flex h-screen">
        <!-- Left Side -->
        <div class="lg:w-1/2 flex flex-col justify-center  h-screen space-y-8 px-12">
            <!-- Upper -->
            <div class="space-y-6">
                <!-- logo -->
                <div>
                ...
                <div>
                    <!-- Text-->
                    <div class=" lg:text-7xl text-gray-500 font-bold leading-tight">
                        Halo, <br class="hidden md"> Silahkan <span class="text-primary">Masuk.</span>
                    </div>
            ...
            <div>
                ...
                <form method="POST" action="{{ route('login') }}" class="flex flex-col space-y-4 w-full">
                    ...
                    <!-- Email -->
                    <x-text-input id="email" class="font-medium w-3/4 px-4 py-2 border-2 border-primary rounded-md 
                    ...
                    <!-- Password -->
                    <x-text-input id="password" class="font-medium w-3/4 px-4 py-2 border-2 border-primary rounded-md 
                        focus:border-secondary focus:ring-0 focus:ring-transparent"
