                    ...
                    <div class="flex w-full md:w-3/4 justify-between items-center">
                        <div class="flex gap-2 items-center">
                            <input id="remember_me" type="checkbox" name="remember"
                                class="text-primary focus:outline-0 focus:ring-0 rounded-sm text-sm md:text-md">
                            <label for="remember_me">Ingat Saya</label>
                        </div>

                        @if (Route::has('password.request'))
                            <a class="text-sm text-primary underline text-sm md:text-md" href="{{ route('password.request') }}">
                                Lupa Kata Sandi?
                            </a>
                        @endif
                    </div>
