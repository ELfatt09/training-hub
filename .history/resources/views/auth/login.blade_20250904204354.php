            ...
            <div>
                ...
                <form method="POST" action="{{ route('login') }}" class="flex flex-col space-y-2 md:space-y-4 w-full">
                    ...
                    <div class="mt-0 md:mt-20 space-y-8">
                        <x-primary-button class="mt-10 bg-primary px-4 py-2 md:px-7 md:py-4 rounded-xl text-white text-[1.7rem] font-bold  
                            border border-primary hover:border-primary hover:bg-transparent hover:text-primary transition w-max tracking-normal text-xs md:text-md">
                            Masuk
                        </x-primary-button>
