<x-guest-layout>
    <section class="w-full flex py-12 md:h-screen">
        <!-- Left Side -->
        <div class="lg:w-1/2 flex flex-col justify-center lg:h-screen space-y-4 md:space-y-8 px-6
        md:px-12">
            <!-- Upper -->
            <div class="space-y-6">
                <!-- logo -->
                <div>
                    <img class="w-1/2 md: lg:w-1/4" src='assets/logo/favicon/logo-trainingHub.svg' alt="">
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="flex flex-col space-y-2 md:space-y-4 w-full">
                    ...
                    <div class="mt-0 md:mt-20 space-y-8">
                        <x-primary-button class="mt-10 bg-primary px-5 py-3 md:px-7 md:py-4 rounded-xl text-white text-[1.7rem] font-bold  
                            border border-primary hover:border-primary hover:bg-transparent hover:text-primary transition w-max tracking-normal text-sm md:text-md">
                            Masuk
                        </x-primary-button>
