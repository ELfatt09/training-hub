<x-guest-layout>
    <section class="w-full flex h-screen">
        <!-- Left Side -->
        <div class="lg:w-1/2 flex flex-col justify-center  h-screen space-y-8 px-6
        md:px-12">
            <!-- Upper -->
            <div class="space-y-6">
                <!-- logo -->
                <div>
                    <img class="w1/2 md:w-1/4" src='assets/logo/favicon/logo-trainingHub.svg' alt="">
                </div>

                <div>
                    <!-- Text-->
                    <div class="text-xl text-gray-500 font-bold leading-tight
                    lg:text-7xl">
