<x-guest-layout>
    <section class="w-full flex flex-row-reverse md:h-screen">
        <!-- Right Side -->
        ...
        md:px-12">
            ...
            <div class="space-y-6">
                <div>
                    <img class="w-1/2 md:3/4 lg:w-1/4" src="assets/logo/favicon/logo-trainingHub.svg" alt="Logo">
                </div>

                <div>
                    <div class="text-2xl text-gray-500 font-bold leading-tight
                    lg:text-7xl">
                        Hai, <br class="hidden md:block"> Silahkan <span class="text-primary">Daftar.</span>
                    </div>
                    <h3 class="text-gray-500 font-medium text-sm md:text-md">Buat akun baru untuk melanjutkan</h3>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="flex flex-col space-y-2 w-full">
                ...
                <x-text-input id="name"
                    class="font-medium w-full lg:w-3/4 px-4 py-2 border-2 border-primary rounded-md
                ...
                <!-- Button -->
                    <div class=" mt-20 space-y-8">
                            ...
                            border border-primary hover:border-primary hover:bg-transparent hover:text-primary transition w-max tracking-normal text-sm ">
