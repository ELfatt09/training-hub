     ...
     <section id="beranda" class="flex h-fit md:h-[85vh] w-full font-jakarta bg-milk">     
        <!-- Left Side -->
         <div class="h-full py-16 md:py-56 w-full px-6 md:w-1/2 md:px-20 space-y-12">
            <!-- Hero text -->
             <div class="space-y-6">
                <div class="w-full flex flex-col md:place-items-center lg:place-items-start">
                    <h1 class="text-primary text-2xl  md:text-7xl font-semibold">Lorem Ipsum</h1>
                    <h2 class="text-black text-lg  md:text-6xl font-semibold line-clamp-2 md:text-center">Dolor sit amet Consectetur Elit</h2>
                </div>
