<x-app-layout class="w-full scroll-smooth">
    ...
    <!-- Hero End -->
        ...
        <div class="flex animate-marquee space-x-12">
            @foreach(['logo-telkom.svg', 'logo-denso.svg', 'logo-adf.svg','logo-bnp.svg','logo-citraHusada.svg','logo-kirana.svg', 'logo-klik.svg', 'logo-sinarmas.svg',  'logo-wika.svg'] as $logo)
