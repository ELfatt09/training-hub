        ...
        <div class="relative overflow-hidden w-full h-[40vh]">
            ...
            <div class="relative flex flex-col items-center justify-center h-full space-y-2">
                ...
                <form class="relative gap-4 w-full flex justify-center items-center" action="">
                    ...
                    <select class="w-1/5 border border-lightoff rounded-md bg-transparent text-white placeholder-[#81ACAD]" aria-placeholder="Klasifikasi..." name="" id="">
                        <option class="text-[#81ACAD]" value="" disabled selected hidden>Klasifikasi...</option>
