        ...
        <div class="w-full flex items-center justify-center h-fit">
            <div class="w-4/5">
                <div class="absolute px-12 py-8 space-y-4">
                    ...
                    <div class="bg-secondary w-full max-w-sm flex justify-center icen text-white px-4 py-2 rounded-md border border-secondary hover:bg-transparent hover:text-secondary transition-all ">
