<x-guest-layout>
    {{-- Section 1 --}}
        <div class="relative overflow-hidden w-full h-[45vh]">
            <img 
            ...
            <div class="relative flex flex-col items-center justify-center h-full space-">
                ...
                <div>
                    <p>
                        Lorem ipsum dolor sit amet consectetur despicit elit.
                    </p>
                </div>
            </div>
        </div>
