    ...
    <div class="relative w-2/3 mx-auto py-6">
        <div class="swiper magangSwiper">
            <div class="swiper-wrapper">
             ...
             <!-- Prev Button -->
    <button class="swiper-button-prev absolute top-1/2 -translate-y-1/2 -left-10 bg-white p-3 rounded-full shadow hover:bg-teal-100">
        <i class="fa-solid fa-chevron-left text-teal-600"></i>
    </button>

    <!-- Next Button -->
    <button class="swiper-button-next top-1/2 -translate-y-1/2 -right-10 bg-white p-3 rounded-full shadow hover:bg-teal-100">
