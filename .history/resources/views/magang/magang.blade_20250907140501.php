...
<script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
    ...
    <div class="relative w-3/4 mx-auto py-6">
        <div class="swiper magangSwiper gap-6">
            <div class="swiper-wrapper">
                ...
                @endforeach
                    ...
                    <!-- Prev Button -->
            <button 
            class="swiper-button-prev absolute top-1/2 -translate-y-1/2 -left-5 
            ...
            <!-- Next Button -->
            <button 
            class="swiper-button-next absolute top-1/2 -translate-y-1/2 right-0 
                    bg-white p-3 rounded-full shadow hover:bg-teal-100 
                    [&::after]:hidden">
