        ...
        <div class="w-full flex items-center justify-center h-fit">
            <div class="w-4/5">
                <div class="absolute px-12">
                    <div class="text-white text-4xl font-bold text-pretty-3 w-full max-w-sm py-8">
                    ...
                    <div class="bg-secondary text-white px-4 py-2 rounded-md border border-secondary hover:bg-transparent hover:text-secondary transition-all ">
